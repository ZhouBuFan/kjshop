...
class Invest extends Controller
{
    ...
    public function index()
    {
        ...
        $is_withdrawal_purchase = $this->request->param('is_withdrawal_purchase');
        $where = '1 ';
        ...
        $query->join('lc_item it','i.itemid=it.id')->like('it.title_zh_cn#it_title,u.username#u_username,i.status#status,i.is_withdrawal_purchase#is_withdrawal_purchase')->dateBetween('i.time#i_time')->order('i.id desc')->page();
    }
