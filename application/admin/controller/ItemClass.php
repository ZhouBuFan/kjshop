...
class ItemClass extends Controller
{
    ...
    protected function _form_filter(&$vo){
        if ($this->request->isGet()) {
            ...
            // $class = Db::name($this->table)->order('sort asc,id asc')->column('id,pid,zh_cn,zh_hk,en_us,th_th,vi_vn,ja_jp,ko_kr,ms_my,pt_pt,tr_tr,es_es,de_de,fr_fr,img,note');
            ...
            // }
            $this->class = Data::arr2table(array_merge([['id' => '0', 'pid' => '-1', 'zh_cn' => '顶级分类']]));
        }
